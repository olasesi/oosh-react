        ...
        <>
            <div className={''}>
                <div className="flex flex-wrap min-h-screen">
                    ...
                    ></div>
                    <aside className={`z-20 fixed transform h-screen lg:translate-x-0 transition duration-300 ease-in-out w-72 lg:w-64 lg:mt-16 overflow-y-auto bg-white pr-4 md:block ${mobileNav ? "translate-x-0" : "-translate-x-full"}`}>
